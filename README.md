...
1. Set up a python 3.8.8 environment in the terminal client
```
conda create -n your_env_name python=3.8.8 anaconda
```
  Afterwhich, please type <mark>y</mark> to proceed and activate the virtal environment with
```
